package com.kevinraupp.api.studydockeraws.security.jwt;

import com.auth0.jwt.JWT;
import com.auth0.jwt.JWTVerifier;
import com.auth0.jwt.algorithms.Algorithm;
import com.auth0.jwt.interfaces.DecodedJWT;
import com.kevinraupp.api.studydockeraws.data.vo.v1.security.TokenVO;
import com.kevinraupp.api.studydockeraws.exceptions.InvalidJwtAuthenticationException;
...
public class JwtTokenProvider {
    ...
    private String getAcessToken(String username, List<String> roles, Date now, Date validity) {
        ...
        return JWT.create().withClaim("roles", roles).withIssuedAt(now).withExpiresAt(validity)
